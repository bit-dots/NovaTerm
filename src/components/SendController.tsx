  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <div className="flex gap-2 p-2">
        <textarea
          className="flex-1 resize-none rounded border border-border bg-panel px-2 py-1 font-mono text-xs text-text-primary placeholder-text-muted outline-none focus:border-accent"
          rows={3}
